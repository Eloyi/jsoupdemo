...
public class WebViewJSBridgePlugin implements JSBridgePlugin {
        ...
        if (messageJson!=null){
            ...
            if (Thread.currentThread() == Looper.getMainLooper().getThread()) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT &&
                    ...
                    mTXWebview.evaluateJavascript(javascriptCommand,null);
                }else {
                    mTXWebview.loadUrl(javascriptCommand);
                }
            }
        }
    }
    ...
    @Override
    public void hackOnPageFinished(WebView webView) {
        BridgeUtil.webViewLoadLocalJs(webView, TO_LOAD_JS);
    ...
    @Override
    public Boolean hackShouldOverrideUrlLoading(String url) {

        if (url.startsWith(BridgeUtil.SWG_RETURN_DATA)) {
            handlerReturnData(url);
            return true;
        } else if (url.startsWith(BridgeUtil.SWG_OVERRIDE_SCHEMA)) {
            flushMessageQueue();
            return true;
        }
