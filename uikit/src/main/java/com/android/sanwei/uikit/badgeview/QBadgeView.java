package com.android.sanwei.uikit.badgeview;
...
import com.android.sanwei.uikit.util.MathUtil;

import java.util.ArrayList;
import java.util.List;

public class QBadgeView extends View implements Badge, SWThemeResource {

    public static final String TAG = "QBadgeView";
    ...
    private QBadgeView(Context context,  AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void initTheme(){
        try {
            mColorBackground =  ResourceHelper.INSTANCE.getColor(getResources().getString(R.string.key_color_badge), this.getContext());

            mColorBadgeText  =  ResourceHelper.INSTANCE.getColor(getResources().getString(R.string.key_color_badge_text), this.getContext());
        }catch (Exception e){
    ...
    public Badge bindTarget(final View targetView) {
        if (targetView == null) {
            Log.w(TAG, "targetView can not be null");
            return null;
        }
        if (getParent() != null) {
        ...
        if (targetParent != null && targetParent instanceof ViewGroup) {
            ...
            Log.w(TAG, "targetView must have a parent");
            return null;
        }
        return this;
    }
    ...
    protected void onAttachedToWindow() {
        ...
        UikitProvider.INSTANCE.getFunViewAttachWindowCallback().invoke(this);
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        UikitProvider.INSTANCE.getFunViewDettachWindowCallback().invoke(this);
    }
