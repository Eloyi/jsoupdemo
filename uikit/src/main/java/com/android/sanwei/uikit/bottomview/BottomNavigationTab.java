...
//        animator.start();
    ...
    public void initialise(boolean setActiveColor){
        initialise(setActiveColor, false);
    }

    @CallSuper
    public void initialise(boolean setActiveColor, boolean isSelected) {
    ...
    public void setLabelKey(String keyTitleResource) {
        keyTitleResource = keyTitleResource;
    }

    public void setIconKey(String keyIconResource) {
        keyIconResource = keyIconResource;
    }
}
