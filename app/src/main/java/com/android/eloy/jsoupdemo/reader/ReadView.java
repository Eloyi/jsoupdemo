...
import com.android.eloy.jsoupdemo.reader.annotation.SlideMode;
...
public class ReadView extends View {
    ...
    private int slideMode = SlideMode.OVERLAP;
    ...
    public void initChapterList(String sourceId, String bookNum, List<Chapter> list, int chapterIndex, int pageIndex) {
