...
import com.android.eloy.jsoupdemo.App;
import com.android.eloy.jsoupdemo.R;
import com.android.eloy.jsoupdemo.reader.annotation.ChapterType;
import com.android.eloy.jsoupdemo.reader.annotation.DensityLevel;
import com.android.eloy.jsoupdemo.reader.annotation.DrawPageType;
import com.android.eloy.jsoupdemo.reader.annotation.FontType;
import com.android.eloy.jsoupdemo.reader.response.Chapter;
import com.android.eloy.jsoupdemo.reader.util.BitmapUtils;
import com.android.eloy.jsoupdemo.reader.util.ScreenUtils;
import com.android.eloy.jsoupdemo.reader.util.ZHConverter;
...
public class PageFactory {
    ...
    public void initBook(String sourceId, String bookNum, List<Chapter> chapters, int currentChapter, int currentPage) {
...
//                LogUtils.e(e.toString());
    ...
    public void setBattery(int value) {
        this.battery = value;
        if (batteryView == null) {
            batteryView = (ProgressBar) LayoutInflater.from(App.getContext())
