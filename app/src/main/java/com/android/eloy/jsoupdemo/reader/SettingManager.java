...
import com.android.eloy.jsoupdemo.reader.util.SPUtils;
...
public class SettingManager {
    ...
    public static int getBrightness() {
        return SPUtils.getInstance().getInt("read_brightness", (int) ScreenUtils.getScreenBrightness(App.getContext()));
    }
